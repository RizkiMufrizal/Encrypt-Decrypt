...
public class App {
    public static void main(String[] args) {
        ...
        String encryptedKey = RSAOAEPWithSHA256.encrypt(secretKey, publicKey);

        System.out.println("Encrypted Key " + encryptedKey);

        String decryptedKey = RSAOAEPWithSHA256.decrypt(encryptedKey, privateKey);

        System.out.println("Decrypted Key " + decryptedKey);

        String message = "Hello Word";

        String encryptedMessage = AES256GCM.encrypt(message, decryptedKey);
